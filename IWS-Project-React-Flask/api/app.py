...
from env.config import db_URI
from flask_sqlalchemy import SQLAlchemy
from flask_marshmallow import Marshmallow
from flask_bcrypt import Bcrypt
import os
from controllers.user import UserSchema
from controllers import BaseModel
...
app.register_blueprint(UserSchema.router, url_prefix="/api")
